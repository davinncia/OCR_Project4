...
public abstract class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(
            ...
            new Meeting("Avancement projet 4", "1562821390990", "Salle B", "phil@gmail.com - marc@hotmail.fr"),
            new Meeting("Budget café", "1562826900390", "Salle A", "phil@gmail.com - marc@hotmail.fr"));
